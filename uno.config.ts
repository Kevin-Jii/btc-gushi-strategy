...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "bui-thinking-trace": "rounded-lg border border-cyan/20 bg-[#0A111A] p-3",
    "bui-thinking-heading": "flex items-center justify-between text-[10px] font-semibold tracking-wide text-cyan",
    "bui-recommendation": "flex items-center justify-between gap-4 rounded-lg border border-line bg-[#0A111A] p-3",
    "bui-recommendation-main": "flex items-center gap-3",
    "bui-recommendation-icon": "grid h-10 w-10 place-items-center rounded-lg",
    "bui-recommendation-icon.positive": "bg-profit/12 text-profit",
    "bui-recommendation-icon.negative": "bg-loss/12 text-loss",
    "bui-recommendation-icon.warning": "bg-warning/12 text-warning",
    "bui-kicker": "block text-[10px] text-muted",
    "bui-confidence": "min-w-24 text-right text-[10px] text-muted",
    "bui-confidence strong": "mt-1 block font-mono text-lg text-ink",
    "bui-confidence-track": "mt-1 h-1 overflow-hidden rounded bg-line",
    "bui-confidence-track span": "block h-full rounded bg-cyan",
    "bui-chip-row": "mt-3 flex flex-wrap items-center gap-2",
    "bui-generated": "ml-auto flex items-center gap-1 text-[10px] text-muted",
    "bui-summary": "mt-3 text-xs leading-5 text-[#A7B1C2]",
    "bui-context-grid": "mt-3 grid gap-1 rounded-lg border border-line bg-bg/35 p-2",
    "bui-context-row": "flex items-start justify-between gap-4 border-b border-line px-2 py-2 text-[10px] text-muted last:border-0",
    "bui-context-row strong": "max-w-[70%] text-right text-ink",
    "bui-insight-grid": "mt-3 grid gap-3 md:grid-cols-2",
    "bui-insight-list": "rounded-lg border border-line bg-bg/25 p-3",
    "bui-insight-list h3": "m-0 text-xs font-semibold text-ink",
    "bui-insight-list ul": "m-2 0 0 0 grid gap-1.5 list-none p-0",
    "bui-insight-list li": "text-[11px] leading-4 text-[#A7B1C2]",
    "bui-insight-list.positive h3": "text-profit",
    "bui-insight-list.negative h3": "text-loss",
    "bui-insight-list p": "m-2 0 0 0 text-[10px] text-muted",
    "bui-status-chip": "inline-flex items-center gap-1 rounded-full border px-2 py-1 text-[10px]",
    "bui-status-chip.neutral": "border-line bg-hover text-muted",
    "bui-status-chip.positive": "border-profit/30 bg-profit/8 text-profit",
    "bui-status-chip.negative": "border-loss/30 bg-loss/8 text-loss",
    "bui-status-chip.warning": "border-warning/30 bg-warning/8 text-warning",
    "bui-status-chip.info": "border-cyan/30 bg-cyan/8 text-cyan",
    "bui-task-rows": "mt-3 grid gap-1.5",
    "bui-task-row": "flex items-start gap-3 border-b border-line px-2 py-2.5 last:border-0",
    "bui-task-icon": "grid h-6 w-6 shrink-0 place-items-center rounded-full border",
    "bui-task-icon.done": "border-profit/50 bg-profit/8 text-profit",
    "bui-task-icon.running": "border-cyan/50 bg-cyan/8 text-cyan",
    "bui-task-icon.pending": "border-line text-muted",
    "bui-task-icon.error": "border-loss/50 bg-loss/8 text-loss",
    "bui-task-row strong": "text-xs text-ink",
    "bui-task-row span:last-child": "text-[9px] text-muted",
    "bui-task-row p": "m-1 0 0 text-[10px] leading-4 text-muted",
    "bui-loading-state": "mt-3 flex items-center gap-2 rounded border border-cyan/25 bg-cyan/5 px-3 py-2 text-[11px] text-cyan",
    "bui-loading-state i": "h-1 w-1 animate-pulse rounded-full bg-cyan",
  },
  preflights: [{
    layer: "base",
    getCSS: () => `

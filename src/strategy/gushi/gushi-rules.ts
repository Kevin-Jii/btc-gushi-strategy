...
export function checkG1(ctx: GushiContext, config: GushiStrategyConfig): boolean {
  const maFlattening =
...
export function checkG2(ctx: GushiContext, config: GushiStrategyConfig): boolean {
  return (
...
export function checkG3(ctx: GushiContext, config: GushiStrategyConfig): boolean {
  return (
    ctx.prevClose < ctx.prevMA60 &&
...
export function checkG4(ctx: GushiContext, config: GushiStrategyConfig): boolean {
...
/** G5：过度上涨的行情开始回撤。 */
export function checkG5(ctx: GushiContext, config: GushiStrategyConfig): boolean {
...
export function checkG6(ctx: GushiContext, config: GushiStrategyConfig): boolean {
  const maWasRising =
...
/** G7：重新站上 MA60 失败后转弱。 */
export function checkG7(ctx: GushiContext, config: GushiStrategyConfig): boolean {
  return (
    ctx.prevClose < ctx.prevMA60 &&
...
export function checkG8(ctx: GushiContext, config: GushiStrategyConfig): boolean {
  return (
